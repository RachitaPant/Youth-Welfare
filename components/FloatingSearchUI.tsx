      ...
      <div className="max-w-[1280px] mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl p-2.5 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100">
          <div className="flex items-center gap-4 bg-gray-50/50 rounded-xl p-1.5 pr-6 border border-gray-100 group">
            <div className="bg-[#1e3a8a] text-white px-3 sm:px-5 py-2 sm:py-2.5 rounded-lg text-[8px] sm:text-[10px] font-black uppercase tracking-widest shrink-0 shadow-lg shadow-blue-900/10">
              Latest Updates
            </div>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-gray-100">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 items-center">
            {STAT_CARDS.map(s => (
              <div key={s.label} className="flex flex-col lg:flex-row items-center lg:items-start gap-2 sm:gap-4 group cursor-default text-center lg:text-left">
                <div className={`w-10 h-10 sm:w-12 lg:w-14 lg:h-14 rounded-xl sm:rounded-2xl ${s.color} flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-sm shrink-0`}>
                  {s.emoji ? (

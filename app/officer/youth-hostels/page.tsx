...
export default function YouthHostelsPage() {
  ...
  const { hostels, meta, loading, error, page, setPage } = useYouthHostels(selectedDistrictId || undefined);
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800">
              {showForm ? 'Register New Youth Hostel' : 'Youth Hostels'}
            </h2>
            {showForm && <p className="text-xs text-gray-500 mt-0.5">Define accommodation details, capacity, and POC</p>}
          </div>
        </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20 text-gray-400">
                ...
                <p className="text-sm">Loading hostels...</p>
              </div>
            ) : error ? (
              ...
              <div className="text-center py-20 text-gray-500">
                <i className="fas fa-hotel text-3xl mb-3 text-gray-200"></i>
                <p className="text-sm">No youth hostels found.</p>
              </div>
            ) : (

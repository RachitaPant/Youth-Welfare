        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800">
              {showForm ? 'New Yuvak Mangal Dal Registration' : 'Yuvak Mangal Dal'}
            </h2>
                      ...
                      <tr key={dal.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-3 font-medium">
                            ...
                            <button className="text-xs text-red-500 hover:text-red-700 transition-all">Delete</button>
                          </div>
                        </td>
                      </tr>
                    ))}

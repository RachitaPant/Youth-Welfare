...
export default function OpenGymPage() {
  ...
  const { gyms, meta, loading, error, page, setPage } = useOpenGyms(selectedDistrictId || undefined);
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800">
              {showForm ? 'Register New Open Gym' : 'Open Gyms'}
            </h2>
            {showForm && <p className="text-xs text-gray-500 mt-0.5">Define outdoor equipment, park location, and POC</p>}
          </div>
        </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
            {loading ? (
              ...
              <div className="text-center py-20 text-gray-500">
                <i className="fas fa-tree text-3xl mb-3 text-gray-200"></i>
                <p className="text-sm">No open gyms found.</p>
              </div>
            ) : (

...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      {/* Mobile Top Bar */}
      <div className="md:hidden bg-blue-800 text-white p-4 flex items-center justify-between sticky top-0 z-[60] shadow-md">
        <div>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed inset-y-0 left-0 w-64 bg-blue-800 text-white flex flex-col z-[56] transform transition-transform duration-300 ease-in-out
